        ...
        <CardBody placeholder="" className="flex flex-col gap-4 p-5 lg:p-10">
                ...
                <div className="flex gap-2">
                  <div className="flex items-center p-2 border border-[#F3EBFF] rounded-lg">
                    <Icon
                      ...
                      className={`text-sm ${
                        available ? "text-secondary" : "text-lightDark"
                      }`}
                    />
                  </div>
                  <div className="flex items-center p-2 border border-[#F3EBFF] rounded-lg">
                  ...
                  >
                    <Typography
                      ...
                      className={`text-base text-center ${
                        item.day === "Sat" ? "text-secondary" : "text-lightDark"
                      }`}
                    >
                      {item.date}
                    </Typography>
          ...
          <div>
            <div className="flex justify-between items-center">
              ...
              <div className="flex gap-4">
                <Select value={to} onChange={handleTo} available={available}>
                  {MONTH_NAMES.map((month) => (
                    <option key={month} value={month}>
                      {month} 2023
                    </option>
          ...
          <div>
            <Radio
              ...
              className="border-secondary before:bg-secondary checked:border-secondary checked:before:border-secondary checked:before:bg-secondary text-secondary"
              iconProps={{
